            ...
            >
                ...
                <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                    <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        ...
                        >
                            <Dialog.Panel className="relative bg-gray-100 dark:bg-gray-800 transform overflow-hidden glass-card px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                                        ...
                                        <div className="mt-4">
                                            ...
                                            {error && (
                                                <p className="mt-1 text-sm text-red-500">
                                                    O texto digitado não corresponde a "{confirmationText}"
                                                </p>
                                            )}
                                        </div>
                                    </div>
